    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-danger mb-2">Invalid Invitation</h1>
          <p className="text-sm text-muted mb-6">{error}</p>
          <a
            href="/landing"
            className="inline-flex items-center justify-center bg-primary text-white rounded-xl px-6 py-3 text-sm font-medium"
          >
            Back to Home
          </a>
        </div>
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <div className="my-8 bg-muted/50 rounded-xl p-4">
          ...
          <p className="text-xs text-muted mt-1">
            {invite?.memberCount} members active
          </p>
